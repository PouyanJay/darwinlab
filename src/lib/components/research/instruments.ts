...
export const INSTRUMENTS: InstrumentMeta[] = [
	{ key: 'sweep', name: 'The Sweep', blurb: 'factorial → effects', ready: true },
	{ key: 'ledger', name: 'The Ledger', blurb: 'claim → verdict', ready: true },
	{ key: 'atlas', name: 'The Atlas', blurb: 'two axes → landscape', ready: true },
	{ key: 'report', name: 'The Report', blurb: 'findings → a brief', ready: false }
];
